...
func main() {
	...
	mux.Handle("PATCH /v1/users/{id}/password", adminOnly(users.ResetPassword))
	...
	mux.Handle("GET /v1/users/{id}/permission-overrides", adminOnly(users.GetPermissionOverrides))
	mux.Handle("PATCH /v1/users/{id}/permission-overrides", adminOnly(users.UpdatePermissionOverrides))
	mux.Handle("GET /v1/users/{id}/entity-grants", adminOnly(users.GetEntityGrants))
	mux.Handle("PATCH /v1/users/{id}/entity-grants", adminOnly(users.UpdateEntityGrants))
	...
	mux.Handle("GET /v1/settings/authentication", superAdminOnly(settings.GetAuthentication))
	mux.Handle("PATCH /v1/settings/authentication", superAdminOnly(settings.UpdateAuthentication))
